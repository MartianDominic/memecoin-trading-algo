...
exports.errorPatterns = exports.ErrorPatternRegistry = void 0;
class ErrorPatternRegistry {
    ...
    extractValue(text, extractor) {
        if (!extractor)
            return undefined;
        const match = text.match(extractor);
        return match ? match[0] : undefined;
    }
    extractAllValues(text, extractors) {
        if (!extractors)
            return {};
        const result = {};
...
exports.ErrorPatternRegistry = ErrorPatternRegistry;
// Export singleton instance
exports.errorPatterns = new ErrorPatternRegistry();
